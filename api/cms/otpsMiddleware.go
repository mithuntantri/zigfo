...
func callnewOTP(firstname, email_id, mobileno, reqType string) bool{
    url := "http://127.0.0.1:2000/otp/create"
    request := fmt.Sprintf("{\"firstname\":\"%s\",\"email_id\":\"%s\",\"mobileno\":\"%s\", \"request_type\":\"%s\"}",
        firstname, email_id, mobileno, reqType)
